...
12. **Описание сценариев использования приложения**
    ...
    |Триггер|Пользователь установил приложение, открыв его попавал на страницу входа, перешел на страницу регистрации|
    ...
    |Триггер|Когда пользователь перешел на в раздел поиска групп|
    ...
    |Триггер|Пользователь попал на экран тренировок|
